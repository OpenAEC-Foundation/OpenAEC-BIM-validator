"""File validation utilities for IFC and IDS files.

This module provides file-level validation including existence checks,
extension validation, and memory preflight checks. No ifc_validator
imports — this is a leaf module.
"""
