...
- `C:\Users\JochemK\.Codex\orchestrator\sessions\bim-validator_latest.md` (indien aanwezig)

Bij sessie EINDE → schrijf update naar:
`C:\Users\JochemK\.Codex\orchestrator\sessions\bim-validator_latest.md`

**Registry:** `C:\Users\JochemK\.Codex\orchestrator\project-registry.json`
